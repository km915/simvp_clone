...
def create_parser():
    ...
    # model parameters
    parser.add_argument('--n_frames_output', type=int, default=10)                  #no. of frames outputted 
    ...
    parser.add_argument('--use_dfa', action='store_true', default=False)   # DFA-CfN gating toggle
